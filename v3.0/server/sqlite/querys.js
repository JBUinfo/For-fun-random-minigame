...
const selectPokemonsFromUserInventory = `
SELECT * FROM UserInventory
INNER JOIN Pokemons ON UserInventory.pokemon_id = Pokemons.pokemon_id
WHERE user_id=(?) AND selected=0`;
const selectPokemonsFromUserBattle = `
SELECT * FROM UserInventory
INNER JOIN Pokemons ON UserInventory.pokemon_id = Pokemons.pokemon_id
...
export const querys = {
  ...
  insertToInventory,
  selectPokemonsFromUserInventory,
  selectPokemonsFromUserBattle,
